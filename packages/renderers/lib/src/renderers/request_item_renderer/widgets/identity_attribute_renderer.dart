...
class _StringIdentityAttributeRenderer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return switch (attribute.value) {
      final AffiliationOrganizationAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final AffiliationRoleAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final AffiliationUnitAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final BirthCityAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final BirthNameAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final BirthStateAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final CityAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final DisplayNameAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final IdentityFileReferenceAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final GivenNameAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final HonorificPrefixAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final HonorificSuffixAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final HouseNumberAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final JobTitleAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final MiddleNameAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final PhoneNumberAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final PseudonymAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final StateAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final StreetAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final SurnameAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final ZipCodeAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final BirthDayAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value.toString()),
      final BirthMonthAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value.toString()),
      final BirthYearAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value.toString()),
      final CitizenshipAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final CommunicationLanguageAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final CountryAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final EMailAddressAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final FaxNumberAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final NationalityAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final SexAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
      final WebsiteAttributeValue value => CustomListTile(title: attribute.value.toJson()['@type'], value: value.value),
