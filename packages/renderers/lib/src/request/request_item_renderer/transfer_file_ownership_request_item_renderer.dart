...
class _DecidableTransferFileOwnershipRequestItemRendererState extends State<TransferFileOwnershipRequestItemRenderer> {
  ...
  void initState() {
    ...
    _isChecked =
        widget.item.initiallyChecked(widget.item.mustBeAccepted, widget.item.requireManualDecision) ||
        (widget.item.response is TransferFileOwnershipAcceptResponseItemDVO);
