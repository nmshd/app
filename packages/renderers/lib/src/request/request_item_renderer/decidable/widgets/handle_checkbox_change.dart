...
void handleCheckboxChange({
  ...
  if (isChecked) {
    controller?.writeAtIndex(index: itemIndex, value: acceptRequestItemParameter);
  } else {
    controller?.writeAtIndex(index: itemIndex, value: const RejectRequestItemParameters());
  }
}
