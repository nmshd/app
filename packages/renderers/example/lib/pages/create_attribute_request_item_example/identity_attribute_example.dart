...
class IdentityAttributeExample extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    CreateAttributeRequestItemDVO createIdentityItem({required IdentityAttributeValue value}) => CreateAttributeRequestItemDVO(
          id: '1',
          name: 'Create 1',
          mustBeAccepted: true,
          isDecidable: false,
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const Divider(),
            RequestRenderer(request: localRequest, currentAddress: 'a currentAddress'),
          ],
        ),
      ),
    );
