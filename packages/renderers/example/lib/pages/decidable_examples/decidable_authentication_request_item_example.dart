...
class DecidableAuthenticationRequestItemExample extends StatefulWidget {
  const DecidableAuthenticationRequestItemExample({super.key});

  @override
  State<DecidableAuthenticationRequestItemExample> createState() => _DecidableAuthenticationRequestItemExampleState();
}

class _DecidableAuthenticationRequestItemExampleState extends State<DecidableAuthenticationRequestItemExample> {
  ...
  Future<void> _loadJsonData() async {
    final jsonData = await rootBundle.loadString('assets/DecidableAuthenticationRequestItem.json');
