...
void main() {
  group('ProprietaryStringAttributeValue toJson', () {
    test('is correctly converted', () {
      ...
      expect(relationshipJson, equals({'@type': 'ProprietaryString', 'title': 'aTitle', 'value': 'aString'}));
    });
    ...
    test('is correctly converted with property "description"', () {
      ...
      final relationshipJson = relationshipAttributeValue.toJson();
      expect(relationshipJson, equals({'@type': 'ProprietaryString', 'title': 'aTitle', 'description': 'aDescription', 'value': 'aString'}));
    });
  ...
  group('ProprietaryStringAttributeValue fromJson', () {
    test('is correctly converted', () {
      ...
      expect(ProprietaryStringAttributeValue.fromJson(json), equals(const ProprietaryStringAttributeValue(title: 'aTitle', value: 'aString')));
    });
