...
void main() {
  ...
  group('PersonName fromJson', () {
    ...
    test('is correctly converted with property "middleName"', () {
      ...
      expect(PersonNameAttributeValue.fromJson(json), equals(const PersonNameAttributeValue(givenName: 'aGivenName', middleName: 'aMiddleName', surname: 'aSurname')));
    });

    test('is correctly converted with property "honorificSuffix"', () {
      final json = {'givenName': 'aGivenName', 'surname': 'aSurname', 'honorificSuffix': 'aHonorificSuffix'};
      expect(PersonNameAttributeValue.fromJson(json), equals(const PersonNameAttributeValue(givenName: 'aGivenName', surname: 'aSurname', honorificSuffix: 'aHonorificSuffix')));
    });

    test('is correctly converted with property "honorificPrefix"', () {
      final json = {'givenName': 'aGivenName', 'surname': 'aSurname', 'honorificPrefix': 'aHonorificPrefix'};
      expect(PersonNameAttributeValue.fromJson(json), equals(const PersonNameAttributeValue(givenName: 'aGivenName', surname: 'aSurname', honorificPrefix: 'aHonorificPrefix')));
    });
