...
void main() {
  group('ConsentRequestItem toJson', () {
    test('is correctly converted', () {
      ...
      expect(requestItemJson, equals({'@type': 'ConsentRequestItem', 'mustBeAccepted': true, 'consent': 'aConsent'}));
    });
    ...
    test('is correctly converted with property "title"', () {
      ...
      final requestItemJson = consentRequestItem.toJson();
      expect(requestItemJson, equals({'@type': 'ConsentRequestItem', 'title': 'aTitle', 'mustBeAccepted': true, 'consent': 'aConsent'}));
    });

    test('is correctly converted with property "description"', () {
      const consentRequestItem = ConsentRequestItem(description: 'aDescription', mustBeAccepted: true, consent: 'aConsent');
      final requestItemJson = consentRequestItem.toJson();
      expect(requestItemJson, equals({'@type': 'ConsentRequestItem', 'description': 'aDescription', 'mustBeAccepted': true, 'consent': 'aConsent'}));
    });
    ...
    test('is correctly converted with property "metadata"', () {
      ...
      final requestItemJson = consentRequestItem.toJson();
      expect(requestItemJson, equals({'@type': 'ConsentRequestItem', 'metadata': {}, 'mustBeAccepted': true, 'consent': 'aConsent'}));
    });
    ...
    test('is correctly converted with property "requireManualDecision"', () {
      ...
      final requestItemJson = consentRequestItem.toJson();
      expect(requestItemJson, equals({'@type': 'ConsentRequestItem', 'mustBeAccepted': true, 'requireManualDecision': true, 'consent': 'aConsent'}));
    });
    ...
    test('is correctly converted with property "link"', () {
      ...
      final requestItemJson = consentRequestItem.toJson();
      expect(requestItemJson, equals({'@type': 'ConsentRequestItem', 'mustBeAccepted': true, 'consent': 'aConsent', 'link': 'www.test.com'}));
    });
  ...
  group('ConsentRequestItem fromJson', () {
    test('is correctly converted', () {
      ...
      expect(ConsentRequestItem.fromJson(json), equals(const ConsentRequestItem(mustBeAccepted: true, consent: 'aConsent')));
    });

    test('is correctly converted with property "title"', () {
      final json = {'title': 'aTitle', 'mustBeAccepted': true, 'consent': 'aConsent'};
      expect(ConsentRequestItem.fromJson(json), equals(const ConsentRequestItem(title: 'aTitle', mustBeAccepted: true, consent: 'aConsent')));
    });
    ...
    test('is correctly converted with property "link"', () {
      ...
      expect(ConsentRequestItem.fromJson(json), equals(const ConsentRequestItem(mustBeAccepted: true, consent: 'aConsent', link: 'www.test.com')));
    });
