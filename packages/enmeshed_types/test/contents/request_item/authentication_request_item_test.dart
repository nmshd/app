...
void main() {
  group('AuthenticationRequestItem toJson', () {
    test('is correctly converted', () {
      ...
      expect(requestItemJson, equals({'@type': 'AuthenticationRequestItem', 'mustBeAccepted': true}));
    });
    ...
    test('is correctly converted with property "description"', () {
      ...
      final requestItemJson = authenticationRequestItem.toJson();
      expect(requestItemJson, equals({'@type': 'AuthenticationRequestItem', 'description': 'aDescription', 'mustBeAccepted': true}));
    });
    ...
    test('is correctly converted with property "metadata"', () {
      ...
      final requestItemJson = authenticationRequestItem.toJson();
      expect(requestItemJson, equals({'@type': 'AuthenticationRequestItem', 'metadata': {}, 'mustBeAccepted': true}));
    });
    ...
    test('is correctly converted with property "requireManualDecision"', () {
      ...
      final requestItemJson = authenticationRequestItem.toJson();
      expect(requestItemJson, equals({'@type': 'AuthenticationRequestItem', 'mustBeAccepted': true, 'requireManualDecision': true}));
    });
  ...
  group('AuthenticationRequestItem fromJson', () {
    test('is correctly converted', () {
      ...
      expect(AuthenticationRequestItem.fromJson(json), equals(const AuthenticationRequestItem(mustBeAccepted: true)));
    });
    ...
    test('is correctly converted with property "description"', () {
      ...
      expect(AuthenticationRequestItem.fromJson(json), equals(const AuthenticationRequestItem(description: 'aDescription', mustBeAccepted: true)));
    });
    ...
    test('is correctly converted with property "metadata"', () {
      ...
      expect(AuthenticationRequestItem.fromJson(json), equals(const AuthenticationRequestItem(metadata: {'aKey': 'aValue'}, mustBeAccepted: true)));
    });

    test('is correctly converted with property "requireManualDecision"', () {
      final json = {'requireManualDecision': true, 'mustBeAccepted': true};
      expect(AuthenticationRequestItem.fromJson(json), equals(const AuthenticationRequestItem(requireManualDecision: true, mustBeAccepted: true)));
    });
