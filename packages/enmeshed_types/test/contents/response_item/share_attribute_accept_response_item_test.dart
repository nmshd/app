...
void main() {
  group('ShareAttributeAcceptResponseItem toJson', () {
    test('is correctly converted', () {
      ...
      expect(
        responseItemJson,
        equals({'@type': 'ShareAttributeAcceptResponseItem', 'result': 'Accepted', 'attributeId': 'anAttributeId'}),
      );
    });
  });
  ...
  group('ShareAttributeAcceptResponseItem fromJson', () {
    test('is correctly converted', () {
      ...
      expect(
        ShareAttributeAcceptResponseItem.fromJson(json),
        equals(const ShareAttributeAcceptResponseItem(attributeId: 'anAttributeId')),
      );
    });
  });
}
