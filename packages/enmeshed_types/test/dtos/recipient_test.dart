...
void main() {
  group('RecipientDTO toJson', () {
    test('is correctly converted', () {
      ...
      expect(dtoJson, equals({'address': 'anAddress', 'relationshipId': 'aRelationshipId'}));
    });
    ...
    test('is correctly converted with property "receivedAt"', () {
      ...
      final dtoJson = dto.toJson();
      expect(dtoJson, equals({'address': 'anAddress', 'receivedAt': '2023', 'relationshipId': 'aRelationshipId'}));
    });
    ...
    test('is correctly converted with property "receivedByDevice"', () {
      ...
      final dtoJson = dto.toJson();
      expect(dtoJson, equals({'address': 'anAddress', 'receivedByDevice': 'aReceiverDeviceId', 'relationshipId': 'aRelationshipId'}));
    });
  ...
  group('RecipientDTO fromJson', () {
    test('is correctly converted', () {
      ...
      expect(RecipientDTO.fromJson(json), equals(const RecipientDTO(address: 'anAddress', relationshipId: 'aRelationshipId')));
    });

    test('is correctly converted with property "receivedAt"', () {
      final json = {'address': 'anAddress', 'receivedAt': '2023', 'relationshipId': 'aRelationshipId'};
      expect(RecipientDTO.fromJson(json), equals(const RecipientDTO(address: 'anAddress', receivedAt: '2023', relationshipId: 'aRelationshipId')));
    });
