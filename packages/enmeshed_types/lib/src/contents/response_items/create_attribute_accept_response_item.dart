...
class CreateAttributeAcceptResponseItem extends AcceptResponseItem {
  ...
  factory CreateAttributeAcceptResponseItem.fromJson(Map json) {
    return CreateAttributeAcceptResponseItem(attributeId: json['attributeId']);
  }

  @override
  Map<String, dynamic> toJson() => {...super.toJson(), '@type': 'CreateAttributeAcceptResponseItem', 'attributeId': attributeId};
