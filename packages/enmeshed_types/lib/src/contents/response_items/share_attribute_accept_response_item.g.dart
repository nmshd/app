...
ShareAttributeAcceptResponseItem _$ShareAttributeAcceptResponseItemFromJson(
  Map<String, dynamic> json,
) => ShareAttributeAcceptResponseItem(
  attributeId: json['attributeId'] as String,
);

Map<String, dynamic> _$ShareAttributeAcceptResponseItemToJson(
  ShareAttributeAcceptResponseItem instance,
) => <String, dynamic>{
