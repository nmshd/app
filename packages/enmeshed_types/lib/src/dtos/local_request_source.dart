...
class LocalRequestSourceDTO extends Equatable {
  ...
  const LocalRequestSourceDTO({required this.type, required this.reference});

  factory LocalRequestSourceDTO.fromJson(Map json) {
    return LocalRequestSourceDTO(type: LocalRequestSourceType.values.byName(json['type']), reference: json['reference']);
  }
