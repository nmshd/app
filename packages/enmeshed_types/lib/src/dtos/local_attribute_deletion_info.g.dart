...
LocalAttributeDeletionInfo _$LocalAttributeDeletionInfoFromJson(
  Map<String, dynamic> json,
) => LocalAttributeDeletionInfo(
  deletionStatus: $enumDecode(
    _$LocalAttributeDeletionStatusEnumMap,
    json['deletionStatus'],
  ),
  deletionDate: json['deletionDate'] as String,
);

Map<String, dynamic> _$LocalAttributeDeletionInfoToJson(
  LocalAttributeDeletionInfo instance,
) => <String, dynamic>{
  'deletionStatus':
      _$LocalAttributeDeletionStatusEnumMap[instance.deletionStatus]!,
...
const _$LocalAttributeDeletionStatusEnumMap = {
  ...
  LocalAttributeDeletionStatus.DeletionRequestRejected:
