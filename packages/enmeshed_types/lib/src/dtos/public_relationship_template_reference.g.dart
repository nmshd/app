...
_$PublicRelationshipTemplateReferenceDTOFromJson(Map<String, dynamic> json) =>
    PublicRelationshipTemplateReferenceDTO(
...
Map<String, dynamic> _$PublicRelationshipTemplateReferenceDTOToJson(
  PublicRelationshipTemplateReferenceDTO instance,
) => <String, dynamic>{
