...
RelationshipDTO _$RelationshipDTOFromJson(Map<String, dynamic> json) =>
    RelationshipDTO(
      ...
      template: RelationshipTemplateDTO.fromJson(
        json['template'] as Map<String, dynamic>,
      ),
      status: $enumDecode(_$RelationshipStatusEnumMap, json['status']),
      peer: json['peer'] as String,
      peerIdentity: IdentityDTO.fromJson(
        json['peerIdentity'] as Map<String, dynamic>,
      ),
      peerDeletionInfo: json['peerDeletionInfo'] == null
          ? null
          : PeerDeletionInfo.fromJson(
              json['peerDeletionInfo'] as Map<String, dynamic>,
            ),
