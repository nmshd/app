...
class DeviceSharedSecret extends Equatable {
  ...
  factory DeviceSharedSecret.fromJson(Map json) {
    return DeviceSharedSecret(
      ...
      secretBaseKey: json['secretBaseKey'].toBase64WithNoPadding(),
      deviceIndex: json['deviceIndex'].toInt(),
      synchronizationKey: json['synchronizationKey'].toBase64WithNoPadding(),
      identityPrivateKey: json['identityPrivateKey'].toBase64WithNoPadding(),
