...
AnnouncementDTO _$AnnouncementDTOFromJson(Map<String, dynamic> json) =>
    AnnouncementDTO(
      ...
      actions: (json['actions'] as List<dynamic>)
          .map((e) => AnnouncementActionDTO.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
AnnouncementActionDTO _$AnnouncementActionDTOFromJson(
...
Map<String, dynamic> _$AnnouncementActionDTOToJson(
  AnnouncementActionDTO instance,
) => <String, dynamic>{
