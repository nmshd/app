...
class IncomingRequestsEndpoint extends Endpoint {
  ...
  Future<ConnectorResponse<LocalRequestDTO>> getRequest(String requestId) =>
      get('/api/v2/Requests/Incoming/$requestId', transformer: localRequestTransformer);

  Future<ConnectorResponse<List<LocalRequestDTO>>> getRequests([Map<String, dynamic>? query]) =>
      get('/api/v2/Requests/Incoming', transformer: localRequestListTransformer, query: query);
}
