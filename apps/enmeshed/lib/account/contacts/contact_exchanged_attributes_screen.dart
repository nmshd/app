    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        if (attribute is SharedToPeerAttributeDVO) {
          ...
          if (attribute.deletionStatus == AttributeDeletionStatus.DeletionRequestSent.name && attribute.sourceAttribute == null) {
            extraLine = Text(context.l10n.contactDetail_deletionRequested, style: extraLineTextStyle);
          }

          if (attribute.deletionStatus == AttributeDeletionStatus.ToBeDeletedByPeer.name && attribute.deletionDate != null) {
            extraLine = Text(
          ...
          if (attribute.deletionStatus == AttributeDeletionStatus.DeletionRequestRejected.name) {
