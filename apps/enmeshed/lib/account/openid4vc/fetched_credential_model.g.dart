...
Offer _$OfferFromJson(Map<String, dynamic> json) => Offer(
  ...
  offeredCredentialConfigurations:
      (json['offeredCredentialConfigurations'] as Map<String, dynamic>).map(
        (k, e) => MapEntry(
          k,
...
Map<String, dynamic> _$OfferToJson(Offer instance) => <String, dynamic>{
  ...
  'offeredCredentialConfigurations': instance.offeredCredentialConfigurations
...
Grant _$GrantFromJson(Map<String, dynamic> json) =>
    Grant(userPinRequired: json['userPinRequired'] as bool?);

Map<String, dynamic> _$GrantToJson(Grant instance) => <String, dynamic>{
  'userPinRequired': instance.userPinRequired,
};

CredentialIssuer _$CredentialIssuerFromJson(Map<String, dynamic> json) =>
    CredentialIssuer(
      display: (json['display'] as List<dynamic>)
          .map((e) => DisplayData.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$CredentialIssuerToJson(CredentialIssuer instance) =>
    <String, dynamic>{
...
DisplayData _$DisplayDataFromJson(Map<String, dynamic> json) => DisplayData(
  ...
  logo: json['logo'] == null
      ? null
      : WebImage.fromJson(json['logo'] as Map<String, dynamic>),
  backgroundImage: json['background_image'] == null
      ? null
      : WebImage.fromJson(json['background_image'] as Map<String, dynamic>),
...
WebImage _$WebImageFromJson(Map<String, dynamic> json) =>
    WebImage(url: json['url'] as String?);
